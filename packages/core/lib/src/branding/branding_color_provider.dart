  ...
  BrandingColors getColorsForBrand(Map<String, dynamic>? colors) {
    return BrandingColors(colors: {
      BrandingColorType.primaryLight:
          _getColorFromCompany(colors, BrandingColorType.primaryLight, const Color(0xFFD65A6D)),
      BrandingColorType.primaryDark:
          _getColorFromCompany(colors, BrandingColorType.primaryDark, const Color(0xFF1B365D)),
